-- Simple Database Views Fix for Stefna
-- Copy and paste this entire script into Supabase SQL Editor

-- Step 1: Add only essential missing columns to media_assets table
ALTER TABLE media_assets ADD COLUMN IF NOT EXISTS visibility TEXT DEFAULT 'private';

-- Step 2: Create simple interaction tables if they don't exist
...
-- Step 6: Create the user_media_with_counts view (simplified)
...
-- Step 7: Create the public_media_with_counts view (simplified)
