...
var { resp: resp2, sanitizeDatabaseUrl: sanitizeDatabaseUrl2 } = (init_auth(), __toCommonJS(auth_exports));
...
exports.handler = async () => {
  try {
    ...
    `;
    console.log(`\u{1F9F9} Cleaned up OTPs: ${result.rowCount || 0} rows affected`);
    return resp2(200, {
      success: true,
