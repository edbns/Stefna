...
// netlify/functions/record-asset.js
...
exports.handler = async (event) => {
  ...
  try {
    ...
    if (!url) {
      return resp2(400, { error: "Missing required field: url" });
    }
    try {
      ...
      return resp2(400, {
        ...
        details: process.env.NODE_ENV === "development" ? dbError.toString() : void 0
      });
    }
  } catch (err) {
    ...
    return resp2(500, {
      ...
      details: process.env.NODE_ENV === "development" ? err.toString() : void 0
    });
  }
};
...
*/
//# sourceMappingURL=record-asset.js.map
