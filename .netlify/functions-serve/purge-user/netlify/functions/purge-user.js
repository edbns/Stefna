...
// netlify/functions/purge-user.js
...
exports.handler = async (event) => {
  try {
    ...
    console.log(`\u{1F5D1}\uFE0F Purging all assets for user: ${userId}`);
    const { data: items, error } = await supabase.from("assets").select("public_id, resource_type, folder").eq("user_id", userId);
...
*/
//# sourceMappingURL=purge-user.js.map
