...
// netlify/functions/mark-notifications-read.ts
var mark_notifications_read_exports = {};
__export(mark_notifications_read_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(mark_notifications_read_exports);
...
var handler = async (event) => {
  try {
    ...
    const { data: updatedCount, error } = await supabaseAdmin.rpc("mark_notifications_read", {
    ...
    return {
      ...
      body: JSON.stringify({
        ...
        message: notificationIds ? `Marked ${updatedCount || 0} notifications as read` : `Marked all notifications as read`
      })
    };
  } catch (error) {
...
*/
//# sourceMappingURL=mark-notifications-read.js.map
