...
exports.handler = async (event) => {
  try {
    ...
    const { data: media, error: fetchErr } = await supabase.from("media_assets").select("id, user_id, public_id, resource_type").eq("id", id).single();
...
*/
//# sourceMappingURL=delete-media.js.map
