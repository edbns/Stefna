...
export const PARALLEL_SELF_PRESETS: ParallelSelfPreset[] = [
  // 🌧️ Rain Dancer
  {
    ...
    label: 'Rain Dancer',
      prompt: 'Transform this person, couple or group of people in the photo into the Rain Dancer or dancers: standing in a cinematic rainstorm, looking like they got caught in the rain by surprise, in the middle of the summer, dressed in their summer clothes, their minimal clothing soaked by water, fabric clinging naturally in motion. Their expression remains true but filled with emotion — resilient yet vulnerable. Surround them with atmosphere: rippling puddles, mist rising, droplets sparkling, and a surreal storm glow that makes the moment feel alive. In the distance, hints of a glowing city emerge through rain and haze — blurred lights, reflections on wet pavement, and an urban backdrop that feels alive but dreamlike. high quality, detailed, detailed features, realistic details',
