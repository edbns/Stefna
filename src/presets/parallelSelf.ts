...
export const PARALLEL_SELF_PRESETS: ParallelSelfPreset[] = [
  // 🌧️ Rain Dancer
  {
    ...
    label: 'Rain Dancer',
    prompt: 'Transform this person, couple or group of people in the photo into the Rain Dancer or dancers: standing in a cinematic rainstorm, their clothing elegantly draped by water, fabric flowing naturally in motion. Their expression remains authentic but filled with emotion — strong yet contemplative. Surround them with atmosphere: rippling puddles, mist rising, droplets sparkling, and a surreal storm glow that makes the moment feel alive. In the distance, hints of a glowing city emerge through rain and haze — blurred lights, reflections on wet pavement, and an urban backdrop that feels alive but dreamlike.',
