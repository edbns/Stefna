...
export const PARALLEL_SELF_PRESETS: ParallelSelfPreset[] = [
  ...
  // 🎨 Colorcore
  {
    ...
    negative_prompt: 'cartoon, anime, multiple people in one frame, overlapping, dark lighting, shadows, patterns, textures, props, gradients, full body, legs, feet, standing pose, walking, cross-dressing, men in dresses, men in feminine clothing, women in masculine suits, gender swap, multiple animals in one frame, more than one animal per person, animal clutter',
    strength: 0.6,
    model: 'fal-ai/nano-banana/edit',
    mode: 'i2i',
    input: 'image',
