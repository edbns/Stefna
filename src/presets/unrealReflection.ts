...
export const UNREAL_REFLECTION_PRESETS: UnrealReflectionPreset[] = [
  ...
  // 🌈 Chromatic Bloom
  {
    ...
    prompt: 'Close-up high-fashion editorial portrait styled for an avant-garde photoshoot. The subject\'s skin is seamlessly textured with intricate iridescent butterfly wing patterns that appear like delicate couture overlays, not painted designs. Hyper-detailed butterflies rest naturally on the head and shoulders, integrated into the styling. Translucent wing patterns accent the contours around the eyes and cheekbones with a subtle bioluminescent glow. If the subject is human, dress them in minimal dark couture fabric or elegant high-fashion styling that complements the surreal design, never casual clothing. Place the subject in a cinematic studio setting with a softly dark misty background, gradients of light, or faint glowing textures that enhance depth and atmosphere. Lighting should be dramatic Rembrandt style with soft shadows. Photoreal, surreal yet elegant, ultra-high detail, sharp focus, professional editorial color grading.',
    negative_prompt: 'cartoon, face paint, cosplay, tribal headdress, carnival costume, casual clothing, t-shirt, fantasy armor, neon glitch, low quality, distortion, butterflies covering entire face',
    strength: 0.55,
    model: 'fal-ai/nano-banana/edit',
    mode: 'i2i',
    input: 'image',
