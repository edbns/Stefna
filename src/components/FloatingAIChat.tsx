  ...
  return (
    <>
      ...
      <motion.button
        ...
        className={`fixed bottom-4 right-4 w-14 h-14 bg-black text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 z-50 flex items-center justify-center ${
      ...
      >
        ...
        {arrowAnimation && (
          <motion.div
            ...
            exit={{ opacity: 0, x: 20 }}
            className="absolute -top-8 right-0 bg-black text-white px-2 py-1 rounded text-xs shadow-lg"
          >
            Ask AI
          </motion.div>
        )}
            ...
            <div className="p-4 border-t border-gray-200 bg-white">
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent bg-white text-black"
                  disabled={isLoading}
                />
                <button
