...
// import AIMLModelService from '../services/aimlModelService' // REMOVED - using fal.ai instead
...
const I2IV2VInterface: React.FC<I2IV2VInterfaceProps> = ({
  ...
  const getAvailableModels = useCallback(() => {
    if (mode === 'i2i') {
      return [
        { id: 'fal-ai/ghiblify', name: 'Ghiblify', description: 'Studio Ghibli style transformations' },
        { id: 'fal-ai/stable-diffusion-xl', name: 'Stable Diffusion XL', description: 'High-quality realistic transformations' },
        { id: 'fal-ai/hyper-sdxl/image-to-image', name: 'Hyper SDXL I2I', description: 'Fast image-to-image generation' }
      ]
    } else {
      return [
        { id: 'fal-ai/fast-sdxl', name: 'Fast SDXL Video', description: 'Fast video generation' },
        { id: 'fal-ai/stable-video-diffusion', name: 'Stable Video Diffusion', description: 'High-quality video generation' }
      ]
    }
  }, [mode])
