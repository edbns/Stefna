  ...
  return (
    <div className={`relative ${className}`}>
      ...
      <button
        ...
        className="relative w-10 h-10 rounded-full bg-black/60 backdrop-blur-sm border border-white/20 flex items-center justify-center transition-all duration-300"
        title="Notifications"
