  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-sm border border-gray-200">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h2 className="text-xl font-semibold text-gray-900">AI Service Test</h2>
      </div>

      {/* Provider Status */}
      <div className="mb-6">
        <div className="flex items-center gap-2 mb-3">
          <h3 className="font-medium text-gray-700">Provider Status</h3>
          <button
        ...
        <div className="grid grid-cols-2 gap-2">
          {Object.entries(providerStatus).map(([provider, status]) => (
            <div key={provider} className="flex items-center gap-2 p-2 bg-gray-50 rounded">
              {status.available ? (
      ...
      <button
        ...
        className="w-full mb-4 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center gap-2"
      >
        {isLoading ? (
          <>
