...
export const ThreadsIcon: React.FC<IconProps> = ({ size = 16, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden>
    <path d="M12.18 24h-.01C8.6 23.98 5.85 22.8 4 20.5 2.3 18.44 1.5 15.59 1.5 12.06V0h3.38v12.06c0 3.21.7 5.7 2.09 7.46 1.39 1.75 3.6 2.63 6.65 2.63s5.26-.88 6.65-2.63c1.39-1.75 2.09-4.24 2.09-7.46V0h3.38v12.06c0 3.53-.85 6.38-2.5 8.43-1.85 2.3-4.6 3.48-8.12 3.5z"/>
  </svg>
)
