    ...
    try {
      ...
      `;
        ...
        `;
            ...
            const updates = {};
            if (incrementDaily)
                updates.daily_usage = (incrementDaily === true ? 1 : Number(incrementDaily));
            if (incrementTotalPhotos)
                updates.total_photos = (incrementTotalPhotos === true ? 1 : Number(incrementTotalPhotos));
