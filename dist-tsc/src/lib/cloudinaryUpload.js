...
export async function uploadToCloudinary(fileOrDataUrl, folder) {
    ...
    try {
        ...
        if (typeof fileOrDataUrl === "string") {
            if (!fileOrDataUrl.startsWith("data:"))
                throw new Error("Non-file string passed to upload");
 ...
 */
export async function uploadAvatarToCloudinary(file, userId) {
