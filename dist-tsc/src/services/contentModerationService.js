...
export var InappropriateCategories;
(function (InappropriateCategories) {
    InappropriateCategories["VIOLENCE"] = "violence";
    InappropriateCategories["HATE_SPEECH"] = "hate_speech";
    InappropriateCategories["SEXUAL_CONTENT"] = "sexual_content";
    InappropriateCategories["DRUGS"] = "drugs";
    InappropriateCategories["SELF_HARM"] = "self_harm";
    InappropriateCategories["HARASSMENT"] = "harassment";
    InappropriateCategories["COPYRIGHT"] = "copyright";
    InappropriateCategories["SPAM"] = "spam";
})(InappropriateCategories || (InappropriateCategories = {}));
class ContentModerationService {
    constructor() {
        // Inappropriate keywords and patterns
        Object.defineProperty(this, "inappropriateKeywords", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map([
        ...
        Object.defineProperty(this, "suspiciousPatterns", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: [
    ...
    async checkPrompt(prompt) {
        ...
        for (const [category, keywords] of this.inappropriateKeywords) {
            const matches = keywords.filter(keyword => lowerPrompt.includes(keyword.toLowerCase()));
            if (matches.length > 0) {
        ...
        const suspiciousMatches = this.suspiciousPatterns.filter(pattern => pattern.test(prompt));
    ...
    async checkGeneratedContent(contentUrl, contentType) {
    ...
    getSuggestedAction(confidence, categories) {
        if (confidence >= 0.8) {
            return 'block';
        }
