...
export async function fromAnyToFile(input) {
    if (input instanceof File)
        return input;
    if (input instanceof Blob)
        return new File([input], 'source.png', { type: input.type || 'image/png' });
    // data: URL
...
export async function getSourceFileOrThrow(candidate) {
...
export function dbgSource(label) {
