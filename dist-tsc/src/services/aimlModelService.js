...
class AIMLModelService {
    ...
    getRecommendedModels(prompt, category) {
    ...
    getOptimalConfig(modelId, prompt, quality = 'standard') {
    ...
    searchModels(query) {
        ...
        return this.models.filter(model => model.name.toLowerCase().includes(lowerQuery) ||
