...
export const POS_SURFER_LOCK = "same person, adult male surfer, holding a surfboard, same pose and angle, same composition, beach and ocean waves";
export const NEG_SURFER_DRIFT = "female, woman, girl, bikini, long hair blowing, dress, banana, banana boat, inflatable, kayak, canoe, paddle, raft, extra people, different subject, face swap, toy boat";
export const SUBJECT_LOCK_NEG = "deformed subject, new faces, age change, child, baby, extra people, different subject, face swap, plastic skin, waxy skin, heavy smoothing";
export function buildEffectivePrompt(opts) {
    const clarity = opts.detail === "hard" ? CLARITY_BOOST_HARD :
